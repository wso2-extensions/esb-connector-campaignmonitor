...
public class CampaignmonitorConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void setEnvironment() throws Exception {
        ...
        init("campaignmonitor-connector-1.0.1-SNAPSHOT");
    ...
    public void testAddSubscribersToListWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_addSubscribersToList_mandatory.json");
    ...
    public void testAddSubscribersToListWithOptionalParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_addSubscribersToList_optional.json");
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testAddSubscribersToListWithOptionalParameters"}, description = "campaignmonitor {addSubscribersToList} integration test with negative case")
    public void testAddSubscribersToListNegativeCase() throws Exception {
